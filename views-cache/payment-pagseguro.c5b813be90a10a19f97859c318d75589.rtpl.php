...
action="https://pagseguro.uol.com.br/v2/checkout/payment.html">  
        ...
        <!-- Campos obrigatórios -->  
        <input name="receiverEmail" type="hidden" value="wilhan_cross@hotmail.com">  
        ...
        <input name="shippingAddressComplement" type="hidden" value="{function="utf8encode($order.descomplement}">  
